...
for index, item in enumerate(items):
    ...
    model.save(f"models/combineddense-{item}.h5")
...
print_to_file(dicts, mccs, items, epochs, batch_size[0], learning_rate, patiences, last_epochs, model, 'combined_DENSE')
make_graphs(histories, items, 'combined_DENSE')