...
# Load the dataset
x_train, y_train, x_test, y_test = load_mnist(items_per_class=10) # 10 items per class means a dataset size of 100
...
items = [10, 50, 250, 500]
print_to_file(dicts, mccs, items, epochs, batch_size, learning_rate, patience, last_epochs, model, 'closs')
