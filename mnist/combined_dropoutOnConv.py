...
print_to_file(dicts, mccs, items, epochs, batch_size[0], learning_rate, patiences, last_epochs, model, 'combined_dropoutOnConv')
make_graphs(histories, items, 'combined_dropoutOnConv')