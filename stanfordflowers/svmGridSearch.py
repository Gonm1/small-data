...
for item in items:
    ...
    param_grid = {'C': [0.001, 0.01, 0.05, 0.5, 1, 2, 3, 5, 10, 15, 20, 30, 50, 100],
                'degree': [1,2,3,4,5,10,20], 
                'kernel': ['rbf','linear']} 

    grid = GridSearchCV(svm.SVC(), param_grid, refit = True, verbose = VERBOSE, n_jobs=15) 
